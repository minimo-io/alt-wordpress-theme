...
function alt_scripts() {
	...
	wp_enqueue_style( 'alt-style', 'https://cdn.jsdelivr.net/npm/@minimo-labs/alt-template@0.5.4/dist/alt.min.css', Array( "alt-bootstrap-minimo", "alt-animate"  ) );
	...
	wp_enqueue_script( 'alt-script', 'https://cdn.jsdelivr.net/npm/@minimo-labs/alt-template@0.5.4/dist/alt.min.js', array( 'jquery' ), NULL , true );
