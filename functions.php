...
function alt_scripts() {
	...
	wp_enqueue_style( 'alt-style', 'https://cdn.jsdelivr.net/gh/minimo-io/alt-template@0.6.11/dist/alt.css', Array( "alt-bootstrap-minimo", "alt-animate"  ), '0.5.5' );
	...
	wp_enqueue_script( 'alt-script', 'https://cdn.jsdelivr.net/gh/minimo-io/alt-template@0.6.11/dist/alt.js', array( 'jquery' ), NULL , true );
